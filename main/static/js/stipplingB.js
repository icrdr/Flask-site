...
float stippling(float density, float size){
  ...
  if(texture2D(tDiffuse, tUv).r < 0.125){
    density *= 1.0;
  }else if(texture2D(tDiffuse, tUv).r < 0.25){
    density *= .825;
  }else if(texture2D(tDiffuse, tUv).r < 0.375){
    density *= .75;
  }else if(texture2D(tDiffuse, tUv).r < 0.5){
    density *= .5;
  }else if(texture2D(tDiffuse, tUv).r < 0.625){
    density *= .375;
  }else if(texture2D(tDiffuse, tUv).r < 0.75){
    density *= .25;
  }else if(texture2D(tDiffuse, tUv).r < 0.825){
    density *= .125;
  }else{
    density *= .0;
  }
